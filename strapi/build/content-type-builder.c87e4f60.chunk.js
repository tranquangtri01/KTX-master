...
"use strict";
var _interopRequireDefault=__webpack_require__(95318);Object.defineProperty(exports, "__esModule", ({value:true}));exports["default"]=void 0;var _react=_interopRequireDefault(__webpack_require__(67294));var _propTypes=_interopRequireDefault(__webpack_require__(45697));var _reactIntl=__webpack_require__(97132);var _Typography=__webpack_require__(49425);var _Box=__webpack_require__(5493);var _Flex=__webpack_require__(67826);var _Stack=__webpack_require__(9008);var _components=__webpack_require__(87387);var CustomRadioGroup=function CustomRadioGroup(_ref){var intlLabel=_ref.intlLabel,name=_ref.name,onChange=_ref.onChange,radios=_ref.radios,value=_ref.value;var _useIntl=(0,_reactIntl.useIntl)(),formatMessage=_useIntl.formatMessage;return/*#__PURE__*/_react["default"].createElement(_Stack.Stack,{spacing:2},/*#__PURE__*/_react["default"].createElement(_Typography.Typography,{variant:"pi",fontWeight:"bold",textColor:"neutral800",htmlFor:name,as:"label"},formatMessage(intlLabel)),/*#__PURE__*/_react["default"].createElement(_components.Wrapper,{horizontal:true,spacing:4,style:{alignItems:'stretch'}},radios.map(function(radio){return/*#__PURE__*/_react["default"].createElement("label",{htmlFor:radio.value.toString(),key:radio.value,className:"container"},/*#__PURE__*/_react["default"].createElement("input",{id:radio.value.toString(),name:name,className:"option-input",checked:radio.value===value,value:radio.value,key:radio.value,onChange:onChange,type:"radio"}),/*#__PURE__*/_react["default"].createElement(_Box.Box,{className:"option",padding:4},/*#__PURE__*/_react["default"].createElement(_Flex.Flex,null,/*#__PURE__*/_react["default"].createElement(_Box.Box,{paddingRight:4},/*#__PURE__*/_react["default"].createElement("span",{className:"checkmark"})),/*#__PURE__*/_react["default"].createElement(_Stack.Stack,{spacing:2},/*#__PURE__*/_react["default"].createElement(_Typography.Typography,{fontWeight:"bold"},formatMessage(radio.title)),/*#__PURE__*/_react["default"].createElement(_Typography.Typography,{variant:"pi",textColor:"neutral600"},formatMessage(radio.description))))));})));};CustomRadioGroup.defaultProps={radios:[]};CustomRadioGroup.propTypes={intlLabel:_propTypes["default"].shape({id:_propTypes["default"].string.isRequired,defaultMessage:_propTypes["default"].string.isRequired,values:_propTypes["default"].object}).isRequired,name:_propTypes["default"].string.isRequired,onChange:_propTypes["default"].func.isRequired,radios:_propTypes["default"].arrayOf(_propTypes["default"].shape({title:_propTypes["default"].shape({id:_propTypes["default"].string.isRequired,defaultMessage:_propTypes["default"].string.isRequired}),description:_propTypes["default"].shape({id:_propTypes["default"].string.isRequired,defaultMessage:_propTypes["default"].string.isRequired}),value:_propTypes["default"].any.isRequired})),value:_propTypes["default"].oneOfType([_propTypes["default"].string,_propTypes["default"].bool]).isRequired};var _default=CustomRadioGroup;exports["default"]=_default;
...
if(!isInContentTypeView){var currentEditedCompo=(0,_lodash.get)(modifiedData,'component',{});(0,_lodash.set)(allCompos,(0,_lodash.get)(currentEditedCompo,['uid'],''),currentEditedCompo);}var composWithCompos=(0,_retrieveComponentsThatHaveComponents.retrieveComponentsThatHaveComponents)(allCompos);return(0,_makeUnique["default"])(composWithCompos);};var getAllNestedComponents=function getAllNestedComponents(){var appNestedCompo=(0,_retrieveNestedComponents["default"])(components);var editingDataNestedCompos=(0,_retrieveNestedComponents["default"])(modifiedData.components||{});return(0,_makeUnique["default"])([].concat((0,_toConsumableArray2["default"])(editingDataNestedCompos),(0,_toConsumableArray2["default"])(appNestedCompo)));};var removeComponentFromDynamicZone=function removeComponentFromDynamicZone(dzName,componentToRemoveIndex){dispatch({type:_constants.REMOVE_COMPONENT_FROM_DYNAMIC_ZONE,dzName:dzName,componentToRemoveIndex:componentToRemoveIndex});};var setModifiedData=function setModifiedData(){var currentSchemas=isInContentTypeView?contentTypes:components;var schemaToSet=(0,_lodash.get)(currentSchemas,currentUid,{schema:{attributes:[]}});var retrievedComponents=(0,_retrieveComponentsFromSchema["default"])(schemaToSet.schema.attributes,components);var newSchemaToSet=(0,_createModifiedDataSchema["default"])(schemaToSet,retrievedComponents,components,isInContentTypeView);var hasJustCreatedSchema=(0,_lodash.get)(schemaToSet,'isTemporary',false)&&(0,_lodash.size)((0,_lodash.get)(schemaToSet,'schema.attributes',[]))===0;dispatch({type:_constants.SET_MODIFIED_DATA,schemaToSet:newSchemaToSet,hasJustCreatedSchema:hasJustCreatedSchema});};var shouldRedirect=(0,_react.useMemo)(function(){var dataSet=isInContentTypeView?contentTypes:components;if(currentUid==='create-content-type'){return false;}return!Object.keys(dataSet).includes(currentUid)&&!isLoading;},[components,contentTypes,currentUid,isInContentTypeView,isLoading]);var redirectEndpoint=(0,_react.useMemo)(function(){var allowedEndpoints=Object.keys(contentTypes).filter(function(uid){return(0,_lodash.get)(contentTypes,[uid,'schema','visible'],true);}).sort();return(0,_lodash.get)(allowedEndpoints,'0','create-content-type');},[contentTypes]);if(shouldRedirect){return/*#__PURE__*/_react["default"].createElement(_reactRouterDom.Redirect,{to:"/plugins/".concat(_pluginId["default"],"/content-types/").concat(redirectEndpoint)});}var submitData=/*#__PURE__*/function(){var _ref6=(0,_asyncToGenerator2["default"])(/*#__PURE__*/_regenerator["default"].mark(function _callee5(additionalContentTypeData){var _initialData$contentT,_initialData$contentT2,isCreating,body,contentType,isValidSchema,method,baseURL,requestURL,oldName,newName;return _regenerator["default"].wrap(function _callee5$(_context5){while(1){switch(_context5.prev=_context5.next){case 0:_context5.prev=0;isCreating=(0,_lodash.get)(modifiedData,[firstKeyToMainSchema,'isTemporary'],false);body={components:(0,_cleanData.getComponentsToPost)(modifiedData.components,components,currentUid,isCreating)};if(!isInContentTypeView){_context5.next=13;break;}contentType=apis.forms.mutateContentTypeSchema(_objectSpread(_objectSpread({},(0,_cleanData.formatMainDataType)(modifiedData.contentType)),additionalContentTypeData),initialData.contentType);isValidSchema=(0,_validateSchema["default"])(contentType);if(isValidSchema){_context5.next=9;break;}toggleNotification({type:'warning',message:{id:(0,_getTrad["default"])('notification.error.dynamiczone-min.validation'),defaultMessage:'At least one component is required in a dynamic zone to be able to save a content type'}});return _context5.abrupt("return");case 9:body.contentType=contentType;trackUsage('willSaveContentType');_context5.next=15;break;case 13:body.component=(0,_cleanData.formatMainDataType)(modifiedData.component,true);trackUsage('willSaveComponent');case 15:method=isCreating?'POST':'PUT';baseURL="/".concat(_pluginId["default"],"/").concat(endPoint);requestURL=isCreating?baseURL:"".concat(baseURL,"/").concat(currentUid);// Lock the app
lockAppWithAutoreload();_context5.next=21;return(0,_helperPlugin.request)(requestURL,{method:method,body:body},true);case 21:unlockAppWithAutoreload();if(isCreating&&(((_initialData$contentT=initialData.contentType)===null||_initialData$contentT===void 0?void 0:_initialData$contentT.schema.kind)==='collectionType'||((_initialData$contentT2=initialData.contentType)===null||_initialData$contentT2===void 0?void 0:_initialData$contentT2.schema.kind)==='singleType')){setCurrentStep('contentTypeBuilder.success');}_context5.next=25;return updatePermissions();case 25:// Submit ct tracking success
...
"use strict";
Object.defineProperty(exports, "__esModule", ({value:true}));exports["default"]=void 0;var validateSchema=function validateSchema(schema){var dynamicZoneAttributes=Object.values(schema.attributes).filter(function(_ref){var type=_ref.type;return type==='dynamiczone';});return dynamicZoneAttributes.every(function(_ref2){var components=_ref2.components;return Array.isArray(components)&&components.length>0;});};var _default=validateSchema;exports["default"]=_default;
...
"use strict";
Object.defineProperty(exports, "__esModule", ({value:true}));exports["default"]=void 0;var startsWithANumber=function startsWithANumber(value){return /^[0-9]/.test(value);};var _default=startsWithANumber;exports["default"]=_default;
...
"use strict";
var _interopRequireDefault=__webpack_require__(95318);Object.defineProperty(exports, "__esModule", ({value:true}));exports["default"]=void 0;var _slugify=_interopRequireDefault(__webpack_require__(46831));var toRegressedEnumValue=function toRegressedEnumValue(value){return(0,_slugify["default"])(value,{decamelize:false,lowercase:false,separator:'_'});};var _default=toRegressedEnumValue;exports["default"]=_default;
