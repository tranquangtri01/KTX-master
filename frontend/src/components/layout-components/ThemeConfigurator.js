...
export const ThemeConfigurator = ({ 
	...
	return (
		<>
			<div className="mb-5">
				<h4 className="mb-3 font-weight-bold">Điều hướng</h4>
				{
					isNavTop ?
					<ListOption 
						name="Top Nav Color:"
				...
				<ListOption 
					...
					selector={
						<Radio.Group 
							...
							value={navType}
						>
							<Radio.Button value={NAV_TYPE_SIDE}>Một bên</Radio.Button>
							<Radio.Button value={NAV_TYPE_TOP}>Bên trên</Radio.Button>
						</Radio.Group>
					}
				/>
				<ListOption 
					name="Màu sắc điều hướng bên trái:"
					selector={
						<Radio.Group
							disabled={isNavTop}
							size="small" 
